...
describe("recording a fact", () => {
  it("offers the writer's own chapters, in order, never an id", () => {
    show([BELIEF]);
  ...
  it("keeps 'not placed yet' selectable, because that is a real state", () => {
    ...
    return userEvent.selectOptions(when, "").then(() => {
