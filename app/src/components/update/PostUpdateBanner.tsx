...
export function PostUpdateBanner({
  ...
  return (
    <div className="flex w-full items-center gap-3 border-b border-success-fill/40 bg-success-soft/30 px-4 py-2 text-xs text-success-strong">
      <span className="inline-block h-1.5 w-1.5 shrink-0 rounded-full bg-success-muted" />
      ...
      <div className="flex-1">
        <p>
          ...
          <button
            ...
            className="ml-2 text-success underline hover:text-success-strong"
          >
            View changelog
          </button>
        </p>
        ...
        {!hasDonated && (
          <p className="mt-0.5 text-mini text-success/80">
            Enjoying the updates? Consider{" "}
            <button
              onClick={() => openLink("https://github.com/sponsors/StoryThread-Dean")}
              className="underline hover:text-success-strong"
            >
      ...
      <button
        ...
        className="rounded border border-success-fill bg-success-fill/40 px-2 py-0.5 text-mini text-success-strong hover:bg-success-fill/60"
      >
        Got it
      </button>
      <button
        onClick={() => setHidden(true)}
        className="rounded px-1.5 py-0.5 text-mini text-success/70 hover:text-success-strong"
