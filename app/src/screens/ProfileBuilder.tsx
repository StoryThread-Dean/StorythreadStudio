        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          ...
          {!editorLoading && profile && (
            <div className="mx-auto max-w-2xl">
              ...
              <div className="mb-6">
                <div className="mb-2 flex items-center justify-between">
                  <h2 className="text-sm font-semibold text-[#f0f0f5]">Full AI Summary</h2>
                  <span
                    className="text-xs text-[#3f3f7a]"
                    title="This section is generated by AI on demand (Phase 4). You can edit it manually."
                  >
                    AI-generated
                  </span>
                </div>
                <textarea
                  ...
                  placeholder="Generated on demand in Phase 4. You can write here manually for now."
                  rows={5}
