...
- **Book Details panel.** A new expandable section at the top of the left nav holds Title, Genre, Tone, Theme, Setting, Word Count target, Point of View, Tense, and Target Audience -- each saved on blur. Everything except the word target is auto-injected into AI prompts as story context; the word target feeds the Writing Progress gauge via the outline.
