...
DEFAULT_RELATIONS: list[dict] = [
    ...
    _rel("loves", "loves", inverse="loved_by", src=["character"], dst=["character"],
    ...
    _rel("exiled_from", "exiled from", inverse="place_of_exile_of", group=GROUP_BELONGING,
         src=["character"], dst=["location", "faction"]),
    _rel("born_in", "born in", inverse="birthplace_of", src=["character"], dst=["location"],
    ...
    _rel("schism_of", "schism of", inverse="split_into", group=GROUP_BELONGING,
         src=["faction", "religion"],
         dst=["faction", "religion"]),
    _rel("believes", "believes", inverse="believed_by", group=GROUP_BELIEF,
         src=["character", "faction"],
         dst=["religion", "lore", "concept"]),
    _rel("practices", "practices", inverse="practised_by", group=GROUP_BELIEF,
         src=["character", "faction"],
         dst=["religion", "concept"]),
    _rel("forbidden_by", "forbidden by", inverse="forbids", group=GROUP_BELIEF,
         src=["concept", "object", "lore"],
         dst=["religion", "faction"]),
    _rel("prophesied_in", "prophesied in", inverse="prophesies", group=GROUP_BELIEF,
         src=["character", "event"],
         dst=["lore", "religion"]),
    ...
    _rel("sacred_to", "sacred to", inverse="holds_sacred", group=GROUP_BELIEF,
         src=["location", "object", "creature"], dst=["religion", "deity"]),
    _rel("native_to", "native to", inverse="home_of", group=GROUP_PLACE,
         src=["creature", "culture"], dst=["location"]),
    _rel("occurred_at", "happened at", inverse="where_it_happened", group=GROUP_THINGS,
    ...
    _rel("formerly_lived_in", "formerly lived in", inverse="former_home_of", group=GROUP_PLACE,
         src=["character", "creature", "culture", "faction"], dst=["location"]),
    _rel("passed_through", "passed through", inverse="passed_through_by", group=GROUP_PLACE,
         src=["character", "creature", "faction"], dst=["location"]),
    _rel("travelling_to", "travelling to", inverse="destination_of", group=GROUP_PLACE,
         src=["character", "creature", "faction"], dst=["location"]),
    ...
    _rel("unaware_of", "does not know the existence of", inverse="unknown_to", group=GROUP_KNOWS,
    ...
    _rel("childhood_friend_of", "childhood friend of", symmetric=True,
         group=GROUP_KNOWS, src=["character"], dst=["character"]),
    _rel("confidant_of", "confidant of", inverse="confides_in", group=GROUP_KNOWS,
         src=["character"], dst=["character"]),
    ...
    _rel("student_of", "student of", inverse="teacher_of", group=GROUP_KNOWS,
         src=["character"], dst=["character"]),
    _rel("knows_of", "knows of", inverse="known_to", group=GROUP_KNOWS,
         src=["character"], dst=["character"]),
    ...
    _rel("widowed_by", "widowed by", inverse="widowed", group=GROUP_INTIMATE,
         src=["character"], dst=["character"]),
    _rel("unrequited_love_for", "in unrequited love with", inverse="loved_without_knowing_by",
         group=GROUP_INTIMATE, src=["character"], dst=["character"]),
    ...
    _rel("sworn_to_destroy", "sworn to destroy", inverse="marked_for_destruction_by", group=GROUP_AGAINST,
         src=["character", "faction"],
         dst=["character", "faction", "religion", "location"]),
    _rel("distrusts", "distrusts", inverse="distrusted_by", group=GROUP_AGAINST,
         src=["character"], dst=["character", "faction"]),
    ...
    _rel("employed_by", "employed by", inverse="employs", group=GROUP_DUTY,
         src=["character"], dst=["character", "faction"]),
    _rel("sworn_to", "sworn to", inverse="holds_the_oath_of", group=GROUP_DUTY,
         src=["character"], dst=["character", "faction", "religion"]),
    _rel("owes_a_debt_to", "owes a debt to", inverse="owed_a_debt_by", group=GROUP_DUTY,
         src=["character", "faction"], dst=["character", "faction"]),
