...
def generate_quick_overview_prompt() -> str:
    ...
    return (
        ...
        "STRUCTURE (the through-line is the character's WANT):\n"
        "1. HOOK: open with their want, or the thing that organizes their days, as a "
        "short punchy line or image.\n"
        "2. BODY: retell the physical, mannerism, and voice details so each one "
        "visibly serves or reveals that want -- habits as ritual, speech as strategy, "
