...
Download the latest installer from the [Releases page](https://github.com/dataguydpeterson-cmyk/StorythreadStudio/releases) and run the `.msi` file.
...
- 💖 [GitHub Sponsors](https://github.com/sponsors/dataguydpeterson-cmyk) — recurring or one-time
