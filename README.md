...
- **Profile Builder** for characters and everything else in your world: structured trait blocks with importance levels, a fantasy and real-world name generator, personality spine pickers, and two character templates so a background character does not cost you a full page
